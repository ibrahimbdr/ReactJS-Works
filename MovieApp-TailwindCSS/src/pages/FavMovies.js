...
export const FavMovies = () => {
  ...
  return (
    <div className='min-h-screen bg-[url("https://cdn.wallpapersafari.com/80/19/A1QxF4.jpg")]'>
        ...
        <h2 className='font-Roboto text-2xl pl-9 pt-8 font-semibold pb-10'>Favorites</h2>
        <div className='flex items-center'>
                    <h4 className='animate-pulse-limited flex items-center'><FcLike className='mr-1 text-2xl'/>{my_FavMovies.length}</h4>
                </div>
        </div>
            ...
            {my_FavMovies.map((film) => {
                return (
                    <div className='w-80 mb-3' key={film.id}>
                        ...
                        <div className='flex justify-between bg-slate-900 text-slate-300 mr-8 p-3'>
